...
func (k *strimziTransporter) EnsureUser(clusterName string) (string, error) {
	...
	updatedKafkaUser.Spec.Authorization.Acls =
		combineACLs(kafkaUser.Spec.Authorization.Acls, desiredKafkaUser.Spec.Authorization.Acls)
...
func combineACLs(kafkaUserAcls []kafkav1beta2.KafkaUserSpecAuthorizationAclsElem,
	desiredKafkaUserAcls []kafkav1beta2.KafkaUserSpecAuthorizationAclsElem) []kafkav1beta2.KafkaUserSpecAuthorizationAclsElem {
